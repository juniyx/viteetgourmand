...
<div class="resucom">
   <div class="resumecommande">
    <p class="resumecommande">Merci pour votre commande, vous pouvez suivre l'avancé de son traitement depuis votre espace utilisateur</p>
    <div class="resumecommande"> voici le résumé de votre commande:</div>
    ...
    <div class="resumecommande"> Prix du menu pour l'ensemble des personnes:<?=$commande->prix_menu?></div>
